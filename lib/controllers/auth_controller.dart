...
class AuthController extends GetxController {
  ...
  void pickImage() async {
    ...
    if (pickedImage != null) {
      Get.snackbar('Profile Picture', 'successfully selected profile pic');
    }
  ...
  void registerUser(
    ...
    try {
      if (username.isNotEmpty &&
        ...
        Get.snackbar('Error', 'Enter every field');
      }
    } catch (e) {
  ...
  void loginUser(String email, String password) async {
    try {
      if (email.isNotEmpty && email.isNotEmpty) {
        ...
        Get.snackbar('Error logging in', 'Please enter all field');
      }
    } catch (e) {
      Get.snackbar('Error', e.toString());
    }
